...
console.log(dinoTwo.dinoLength);
...
for (let i=0; i <universities.length; i++){
  univSorted.push(universities[i]);
  univSorted.sort();
}

console.log(univSorted);
...
let unisWithUni = graduates.filter(function(items){
...
let animalPop = zooAnimals.map(animal => animal.population);
populationTotal = animalPop.reduce((sum, population) => sum + population);
